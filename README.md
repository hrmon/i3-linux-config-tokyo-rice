...
You can check out my blog post on the set up [here](https://vickylai.com/verbose/how-a-lifelong-windows-user-switched-to-linux-the-hard-way/). You can ask me about it on Twitter: [@hivickylai](https://twitter.com/hivickylai).
